...
const std::vector<const char*> all_spirv_paths = {
    ...
    "../tests/descriptor_heap/glsl/bindless.frag.spv",
    "../tests/descriptor_heap/glsl/bindless.vert.spv",
    "../tests/descriptor_heap/glsl/per_draw.frag.spv",
    "../tests/descriptor_heap/glsl/per_draw.vert.spv",
    "../tests/descriptor_heap/slang/as_heap.comp.spv",
    "../tests/descriptor_heap/slang/bindless.frag.spv",
    "../tests/descriptor_heap/slang/bindless.vert.spv",
    "../tests/descriptor_heap/slang/multi_type_heap.comp.spv",
    "../tests/descriptor_heap/slang/per_draw.frag.spv",
    "../tests/descriptor_heap/slang/per_draw.vert.spv",
